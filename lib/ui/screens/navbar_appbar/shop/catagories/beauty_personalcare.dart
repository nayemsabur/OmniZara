...
class BeautyPersonalcare extends StatefulWidget {
  const BeautyPersonalcare({super.key});

  @override
  State<BeautyPersonalcare> createState() => _BeautyPersonalcareState();
}

class _BeautyPersonalcareState extends State<BeautyPersonalcare> with SingleTickerProviderStateMixin {
