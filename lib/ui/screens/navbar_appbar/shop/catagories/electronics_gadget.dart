...
class ElectronicsGadget extends StatefulWidget {
  const ElectronicsGadget({super.key});

  @override
  State<ElectronicsGadget> createState() => _ElectronicsGadgetState();
}

class _ElectronicsGadgetState extends State<ElectronicsGadget> with SingleTickerProviderStateMixin {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Electronics Gadget", style: TextStyle(color: Colors.white)),
          centerTitle: true,
