...
class ToyBabiesProduct extends StatefulWidget {
  const ToyBabiesProduct({super.key});

  @override
  State<ToyBabiesProduct> createState() => _ToyBabiesProductState();
}

class _ToyBabiesProductState extends State<ToyBabiesProduct> with SingleTickerProviderStateMixin {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Toy & Babies Product", style: TextStyle(color: Colors.white)),
          centerTitle: true,
