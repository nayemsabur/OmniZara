...
class SportsOutdoor extends StatefulWidget {
  const SportsOutdoor({super.key});

  @override
  State<SportsOutdoor> createState() => _SportsOutdoorState();
}

class _SportsOutdoorState extends State<SportsOutdoor> with SingleTickerProviderStateMixin {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Sports & Outdoor", style: TextStyle(color: Colors.white)),
          centerTitle: true,
