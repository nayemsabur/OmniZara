...
class BooksStationary extends StatefulWidget {
  const BooksStationary({super.key});

  @override
  State<BooksStationary> createState() => _BooksStationaryState();
}

class _BooksStationaryState extends State<BooksStationary> with SingleTickerProviderStateMixin {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Books & Stationary", style: TextStyle(color: Colors.white)),
          centerTitle: true,
