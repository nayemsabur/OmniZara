...
class HomeLiving extends StatefulWidget {
  const HomeLiving({super.key});

  @override
  State<HomeLiving> createState() => _HomeLivingState();
}

class _HomeLivingState extends State<HomeLiving> with SingleTickerProviderStateMixin {
