...
class GroceriesFood extends StatefulWidget {
  const GroceriesFood({super.key});

  @override
  State<GroceriesFood> createState() => _GroceriesFoodState();
}

class _GroceriesFoodState extends State<GroceriesFood> with SingleTickerProviderStateMixin {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Groceries & Food", style: TextStyle(color: Colors.white)),
          centerTitle: true,
