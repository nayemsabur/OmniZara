...
class _HealthWellnessState extends State<HealthWellness> with SingleTickerProviderStateMixin {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(actions: [
          ...
          title: const Text("Health & Wellness", style: TextStyle(color: Colors.white)),
          centerTitle: true,
